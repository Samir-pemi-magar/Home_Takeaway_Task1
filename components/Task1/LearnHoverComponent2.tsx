...
export default function LearnHoverComponent2({ onPrev }: Props) {
  return (
    <div className="relative w-[592px] h-[341px]">
      ...
      <div className="absolute right-0 bottom-0 w-[572px] h-[317px]">
        <Image
          src="/Images/LearnHuman01.png"
          alt="Learn"
          width={572}
          height={317}
      ...
      <span className="font-bold text-[20px] font-nohemi text-white absolute top-8 left-1/2 -translate-x-1/2 w-[353px] text-center">
        Laptops, lessons, and a whole lot of growth!
      </span>
      <button
        onClick={onPrev}
        className="bg-[#FAFAFA] rounded-full p-4 shadow-[0px_12px_12px_rgba(0,0,0,0.3)] absolute top-34 left-px z-10 border border-[#1018281f]"
      >
        <svg
          width="32"
          height="32"
      ...
      <button className="bg-[#FAFAFA] rounded-full p-4 shadow-[0px_12px_12px_rgba(0,0,0,0.3)] absolute top-34 z-10 right-px -scale-x-100 border border-[#1018281f]">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
